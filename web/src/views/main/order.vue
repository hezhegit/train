<template>
  ...
  <a-modal v-model:visible="imageCodeModalVisible" :title="null" :footer="null" :closable="false"
    ...
    <a-button type="primary" block @click="handleOk" danger>输入验证码后开始购票</a-button>
  </a-modal>
  ...
  <a-modal v-model:visible="firstImageCodeModalVisible" :title="null" :footer="null" :closable="false"
    ...
    <a-button type="primary" block @click="validFirstImageCode" danger>提交验证码</a-button>
  </a-modal>
  ...
  <a-modal v-model:visible="lineModalVisible" title="排队购票" :footer="null" :maskClosable="false" :closable="false"
    ...
    <br/>
    <a-button type="primary" @click="onCancelOrder" danger>取消购票</a-button>
  </a-modal>
</template>
    ...
    const handleOk = () => {
      ...
      axios.post("/business/confirm-order/do", {
        ...
        if (data.success) {
          ...
          confirmOrderId.value = data.data.id;
          queryLineCount();
        } else {
          notification.error({description: data.message});
        }
