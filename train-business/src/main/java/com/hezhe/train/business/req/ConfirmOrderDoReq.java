...
public class ConfirmOrderDoReq {
    ...
    public @NotEmpty(message = "【车票】不能为空") List<ConfirmOrderTicketReq> getTickets() {
        return tickets;
    }

    public void setTickets(@NotEmpty(message = "【车票】不能为空") List<ConfirmOrderTicketReq> tickets) {
